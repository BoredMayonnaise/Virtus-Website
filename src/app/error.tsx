    ...
    <div className="min-h-screen bg-[#0A1118] text-[#F3F4F6] flex flex-col justify-between selection:bg-[#FFE600] selection:text-black">
      ...
      <main className="flex-1 flex items-center justify-center p-6 text-center">
        <div className="max-w-xl space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-amber-950/40 border border-amber-800/60 text-amber-300 font-mono text-xs font-bold">
            <span className="h-2 w-2 rounded-full bg-amber-400 animate-ping" />
            UNEXPECTED RUNTIME INTERRUPT
          </div>

          <h1 className="font-monument text-3xl sm:text-5xl font-black uppercase tracking-tight text-white">
          ...
          {error?.message && (
            <div className="p-4 bg-black/60 border border-white/15 rounded text-left font-mono text-xs text-rose-300 overflow-x-auto">
